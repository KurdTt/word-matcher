...
public class WordPatternMatcherImpl implements WordPatternMatcher {
    ...
    private static final WordMatcherTaskResult EMPTY_RESULT = new WordMatcherTaskResult(-1, -1);

    @Override
    public WordMatcherTaskResult match(String input, String pattern) {
    ...
    WordMatcherTaskResult matchInputWithPattern(String input, String pattern) {
        ...
        return new WordMatcherTaskResult(position, typos);
    }
